        ...
        <div class="container">
            <div class="row justify-content-center">
                                ...
                                @if ($paymentrequests->count())
                                    @foreach ($paymentrequests as $paymentrequest)
                                        <tr>
                                            <td><?= $paymentrequest->description ?>
                                            <td>
                                            <td><span class="float-right"><a
                                                            href="{{ $paymentrequest->payment_url }}"><i
                                                                class="fas fa-hand-holding-usd"
                                                                style="font-size: 30px; margin-right: 20px;"></i></a></span>
                                            </td>
                                        </tr>
                                    @endforeach
                                @else
                ...
                <div class="col-md-4">
                    ...
                    <div class="card" style="margin-bottom: 35px;">
                        <div class="card-header"><a href="{{ route('contact.index') }}">{{ __('header.contact') }}</a>
                        </div>
